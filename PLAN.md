...
4. Worth considering once alerts have been lived with: clearing a flag from the strip itself, and whether a flagged block should carry a deadline the way a Jot todo does.
